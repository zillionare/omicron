...
class MyTestCase(unittest.TestCase):
    ...
    def test_get_frames_by_count(self):
        ...
        for i in range(len(days)):
            ...
            logger.info("get_frames_by_count(%s, %s, %s)->%s", end, n, FrameType.DAY,
                        actual)
    ...
    def test_get_frames(self):
        ...
        for i in range(len(days)):
            ...
            logger.info("get_frames(%s, %s, %s)->%s", start, end, FrameType.DAY,
                        actual)
        ...
        for i, (end, n, expected) in enumerate(X):
            ...
            logger.info("get_frames(%s, %s, %s)->%s", start, end, FrameType.MIN30,
                        actual)
            self.assertListEqual(expected, actual)
