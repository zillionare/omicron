...
class StockTest(unittest.IsolatedAsyncioTestCase):
    ...
    def test_choose_by_date(self):
        # 测试获取股票，过滤掉还没上市的股票
        codes = Stock.choose_listed(arrow.get("2000-01-01").date(), [SecurityType.STOCK.value])
        ...
        codes = Stock.choose_listed(arrow.get("2007-01-01").date(), [SecurityType.STOCK.value])
        self.assertEqual(codes, ['000001.XSHE', '000005.XSHE', '600000.XSHG', '000007.XSHE'])
